...
# """ 你的 APPID AK SK """
# APP_ID = '26964244'
# API_KEY = 'ncm3oCypcKXZtZDT5Esl2DIh'
# SECRET_KEY = 'Ar6gfH4F1jq8oGqpsaL04AXRbn4OuZR9'

# client = AipSpeech(APP_ID, API_KEY, SECRET_KEY)

# result  = client.synthesis('大家带了身份证的交给组长，没有带的趁休息时间回宿舍拿，组长收齐后交到第一排辛苦大家', 'zh', 1, {
#     'vol': 5,
# })
...
# subscription_key = 'e8ad8cf4515348b7a7b68d7241bf41db'
...
def text_to_mp3(text: str) -> None:
    ...
    file_name = "H:/WORKSPACE/Django/djangoProject/polls/static/audio/outputaudio.mp3"
